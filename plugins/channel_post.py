...
async def channel_post(client: Client, message: Message):
    reply_text = await message.reply_text("𝙿𝚕𝚎𝚊𝚜𝚎 𝚆𝚊𝚒𝚝...!", quote = True)
    try:
        ...
        print(e)
        await reply_text.edit_text("𝚂𝚘𝚖𝚎𝚝𝚑𝚒𝚗𝚐 𝚠𝚎𝚗𝚝 𝚆𝚛𝚘𝚗𝚐..!")
        return
    ...
    reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("🔁 𝚂𝙷𝙴𝙰𝚁 𝚄𝚁𝙻", url=f'https://telegram.me/share/url?url={link}')]])

    await reply_text.edit(f"<b>♨️ 𝙷𝚎𝚛𝚎 𝚒𝚜 𝚢𝚘𝚞𝚛 𝚕𝚒𝚗𝚔</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
